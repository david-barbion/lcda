    ...
    template = {
      template: {
        ...
        sections: {
           ...
           "link_to_article": "<a class=\"mcnButton\" title=\"Lire l'article\" href=\"#{args[:link]}\" target=\"_self\" style=\"font-weight:bold;letter-spacing:-.5px;line-height:100%;text-align:center;text-decoration:none;color:#FFFFFF;\">Lire l'article</a>"
        }
      }
    }
